...
class DMCCC(SellingController):
	...
	def __init__(self, *args, **kwargs):
		super(DMCCC, self).__init__(*args, **kwargs)
	...
	def validate_warehouse(self):
		super(DMCCC, self).validate_warehouse()
	...
	def validate_with_previous_doc(self):
		super(DMCCC, self).validate_with_previous_doc(
			{
